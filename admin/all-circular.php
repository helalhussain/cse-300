           ...
           <div class="container my-5">
            ...
            <div class="container">
                ...
                <tr>
                    ...
                    style="width:80px;height:60px;border-radius:50%;"/></td>
                    <td style="font-weight:bold"><?php echo $all_recipe['title'] ?></td>
                    <td style="font-weight:bold"><?php echo $all_recipe['description'] ?></td>
                    <td class="text-center"><?php 
                        echo "<a href='delete_circular.php?id=$all_recipe[id]' class='btn btn-danger'>Delete</a>";
                        
                            ?>
                    </td>
                    <td class="text-center"><?php 
                        echo "<a href='edit-circular.php?id=$all_recipe[id]' class='btn btn-success'>Edit</a>";
