...
<?php include('sidebar.php'); ?>		
        ...
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Food News</h2>
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="form-actions">
                            <button type="submit" name="upload" class="btn btn-primary">Add News</button>
                        </div>
                    </fieldset>
                </form>
...
<?php
	...
	$title = $_POST['title'];
      ...
      $date = date("Y/m/d");
      $status =1;
	  $sql = "INSERT INTO recipenews VALUES(NULL,'$title','$description','$image_1','$status')";
