...
<?php include('sidebar.php'); ?>		
        ...
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Kitchen Tools</h2>
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="form-actions">
                            <button type="submit" name="upload" class="btn btn-success">Add Kitchen Tools</button>
                        </div>
                    </fieldset>
                </form>
...
<?php
      ...
      //$date = date("Y/m/d");
	  $sql = "INSERT INTO kitchentools( title, description, image, date, price, quantity) VALUES('$title','$description','$image_1',now(), '$peice','$quantity')";
      $query = mysqli_query($conn,$sql);

            if($query){?>
        
        <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/RecipeBD/admin/all_kitchen_tools.php"> 
          <?php  }
