            ...
            <div class="box-content">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="date01">Time</label>
                            <div class="controls">
                                <input type="time" class="input-xlarge" name="time" required>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="date01">Date</label>
                            <div class="controls">
                                <input type="date" class="input-xlarge" name="date" required>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="form-actions">
                            <button type="submit" name="upload" class="btn btn-primary">Add Show</button>
                        </div>
                    </fieldset>
                </form>
...
<?php
      ...
      $date = date("Y/m/d");
	  $sql = "INSERT INTO shows VALUES(NULL,'$title','$description','$time', '$date','$image_1','$date')";
