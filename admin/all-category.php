           ...
           <div class="container my-5">
            ...
            <div class="container">
                ...
                <tbody class="text-secondary bg-light">
                    ...
                    $recipe_query ="SELECT * FROM category";
                ...
                <tr>
                    ...
                    <td style="font-weight:bold"><?php echo $all_recipe['category'] ?></td>
                    </td>
                    <td class="text-center"><?php 
                        echo"<a href='delete_catergory.php?id=$all_recipe[id]'class='btn btn-danger'>Delete</a>";
