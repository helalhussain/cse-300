           ...
           <div class="container my-5">
            ...
            <div class="container">
                ...
                <tbody class="text-secondary bg-light">
                    ...
                    $recipe_query ="SELECT * FROM trick";
                ...
                <tr>
                    ...
                    <td class="text-center"><?php 
                        echo"<a href='delete_trick.php?id=$all_recipe[id]' class=' btn btn-danger'>Delete</a>";
                        
                            ?>
                    </td>
                    <td class="text-center"><?php 
                        echo"<a href='edit-trick.php?id=$all_recipe[id]' class=' btn btn-success'>Edit</a>";
