...
<?php include('sidebar.php'); ?>		
           ...
           <div class="container my-5">
            ...
            <h5 class="py-3">All Food News</h5>
            ...
            <div class="container">
                ...
                <tr>
                    ...
                    <td style="font-weight:bold"><img src="<?php echo $all_recipe['image_1'] ?>" 
                    style="width:120px;height:80px;border-radius:50%;"/></td>
                    <td style="font-weight:bold"><?php echo $all_recipe['title'] ?></td>
                    <td style="font-weight:bold"><?php echo $all_recipe['description'] ?></td>

                    <td class="text-center"><?php 
                        echo"<a href='delete_foodnews.php?id=$all_recipe[id]' class=' btn btn-danger'>Delete</a>";
