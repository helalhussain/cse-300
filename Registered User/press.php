...
<?php include('header.php'); ?>
		...
		<section class="top__blog">
			<div class = "container">
                ...
                while($row = mysqli_fetch_assoc($run_recipe_query)){
                ?>				
			
					<div class = "col-lg-4 col-md-6 electronic">
					 <div class = "product-item">
							<!-- <div class = "product-img">
								<img src = "../admin/"  class = "img-fluid d-block mx-auto" style="height:200px;width:300px;">
							</div> -->
							<div class = "product-content text-center py-3">
								
								<a href="<?php echo $row['siteLink'];?>">
									<h5 class = "d-block text-uppercase fw-bold"><?php echo $row['title'];?></h5>
								</a>
